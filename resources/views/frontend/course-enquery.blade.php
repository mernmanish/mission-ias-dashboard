...
@section('title', 'Mission IAS | Course Enquiry')
@section('content')
                            ...
                            <div class="row">
                                ...
                                <form action="#" id="course-enquiry" class="white-popup-block">
                                    <div class="course-enquery-data">
                                        <h4 class="text-center">Enquery for {{$course->name;}}</h4>
                                        <div class="col-md-5 login-social text-center" style="margin-top: 10px;">
                                            <img src="{{asset($course->image)}}" style="max-width: 100%; height:250px;">
                                            <h4 class="text-center mt-4">{{$course->name;}}</h4>
                                            <div class="price"><del class="text-danger">Price: ₹{{$course->course_fee}}</del> <b style="font-size: 15px; color:#0a9e15">Offer Price: ₹{{$course->discount_fee}}</b></div>
                                        </div>
