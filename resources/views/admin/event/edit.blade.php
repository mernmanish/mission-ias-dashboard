...
@section('breadcrumb', 'Update Event')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Update Event <a href="{{ route('all-event') }}" class="btn btn-dark pull-right">Event List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Update Event Details</h5>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="course_id" id="course_id" class="form-control" style="padding: 7px;">
                            ...
                            <option value="{{$rows->id}}" {!! $event->course_id==$rows->id ? "selected" : '' !!}>{{$rows->name}}</option>
                           @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="category_id" id="category_id" class="form-control" style="padding: 7px;">
                            ...
                            @if($event->course_id==$rows->course_id)
                            <option value="{{$rows->id}}" {!! $event->category_id==$rows->id ? "selected" : '' !!}>{{$rows->name}}</option>
                            @endif
                            @endforeach
                        </select>
                        @if ($errors->has('category_id'))
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="subcategory_id" id="subcategory_id" class="form-control" style="padding: 7px;">
                            ...
                            @if($event->category_id==$rows->category_id)
                            <option value="{{$rows->id}}" {!! $event->subcategory_id==$rows->id ? "selected" : '' !!}>{{$rows->name}}</option>
                            @endif
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Video Name" id="event_name" name="event_name" value="{{$event->event_name}}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Video Link" id="video_link" name="video_link" value="{{$event->video_link}}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="source_type" id="station1" value="Station 1" {!! $event->source_type=='Station 1' ? "checked" : '' !!}>
                                <label class="custom-control-label" for="station1">Station 1</label>
                            </div>

                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="source_type" id="station2" value="Station 2" {!! $event->source_type=='Station 2' ? "checked" : '' !!}>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="access" id="free" value="Free" {!! $event->access=='Free' ? "checked" : '' !!}>
                                <label class="custom-control-label" for="free">Free</label>
                            </div>

                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="access" value="Paid" id="paid" {!! $event->access=='Paid' ? "checked" : '' !!}>
