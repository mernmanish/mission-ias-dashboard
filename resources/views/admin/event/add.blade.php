...
@section('breadcrumb', 'Add Event')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Add Event <a href="{{ route('all-event') }}" class="btn btn-dark pull-right">Events List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Event Details</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Event Name" id="event_name" name="event_name">
