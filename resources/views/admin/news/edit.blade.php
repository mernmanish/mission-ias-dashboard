...
@section('breadcrumb', 'Update News')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Update News <a href="{{ route('all-news') }}" class="btn btn-dark pull-right">News List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Update News Details</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter News Title" id="news_title" name="news_title" value="{{$news->news_title}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" placeholder="Enter Date" id="date" name="date" value="{{$news->date}}">
                        @if ($errors->has('date'))
                        <span class="help-block errorText">
                        {{ $errors->first('date') }}
                        </span>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="time" class="form-control" placeholder="Enter Time" id="time" name="time" value="{{$news->time}}">
                        @if ($errors->has('time'))
                        <span class="help-block errorText">
                        {{ $errors->first('time') }}
                        </span>
