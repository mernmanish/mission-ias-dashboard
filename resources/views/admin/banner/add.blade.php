...
@section('breadcrumb', 'Add Banner')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Add Banner <a href="{{ route('all-banner') }}" class="btn btn-dark pull-right">Banners List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Banner</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Banner Title" id="banner_title" name="banner_title">
