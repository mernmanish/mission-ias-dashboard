...
@section('breadcrumb', 'Add Book')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Add Book <a href="{{ route('all-books') }}" class="btn btn-dark pull-right">Books List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Book Details</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Book Title" id="book_title" name="book_title">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Book Price" id="book_price" name="book_price" onkeypress="if(this.value.length==4) return false;" onkeydown="return event.keyCode !== 69">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Sale Book Price" id="book_sale_price" name="book_sale_price" onkeypress="if(this.value.length==4) return false;" onkeydown="return event.keyCode !== 69">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Book Link" id="book_link" name="book_link">
