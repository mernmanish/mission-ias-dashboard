...
@section('breadcrumb', 'Add Live Class')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Add Live Class <a href="{{ route('all-live-class') }}" class="btn btn-dark pull-right">Live Classes List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Live Class</h5>
