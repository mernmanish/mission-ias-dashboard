                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="course_id" id="course_id" class="form-control" style="padding: 7px;">
                            ...
                            <option value="{{$rows->id}}" {!! $test->course_id==$rows->id ? "selected" : '' !!}>{{$rows->name}}</option>
                           @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="subcategory_id" id="subcategory_id" class="form-control" style="padding: 7px;">
                            ...
                            @if($test->subcategory_id==$rows->id)
                            <option value="{{$rows->id}}" {!! $test->subcategory_id==$rows->id ? "selected" : '' !!}>{{$rows->name}}</option>
                            @endif
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Test Series Name" id="test_series_name" name="test_series_name" value="{{$test->test_series_name}}">
                    ...
                    {{-- <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Price" id="price" name="price" onkeypress="if(this.value.length==4) return false;" onkeydown="return event.keyCode !== 69" value="{{$test->price}}">
                        @if ($errors->has('price'))
                        <span class="help-block errorText">
                        {{ $errors->first('price') }}
                        </span>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Test Time in Minutes" id="time" name="time" onkeypress="if(this.value.length==3) return false;" onkeydown="return event.keyCode !== 69" value="{{$test->time}}">
                        @if ($errors->has('time'))
                        <span class="help-block errorText">
                        {{ $errors->first('time') }}
                        </span>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Post By" id="post_by" name="post_by" value="{{$test->post_by}}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered btn-sm table-hover text-center">
                                ...
                                <tbody id="appendCategory">
                                    ...
                                    $no_of_question = explode(",",$test->no_of_question);
                                    @endphp
                                    @foreach($test_category as $key =>$vals)
                                    <tr>
                                        <td> <input type="text" class="form-control" placeholder="Enter Test Category" id="test_category" name="test_category[]" value="{{$vals}}"></td>
                                        <td><input type="text" class="form-control" placeholder="Enter No of Question" id="no_of_question" name="no_of_question[]" value="{{$no_of_question[$key]}}"></td>
                    ...
                    <div class="form-group col-md-12">
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" name="is_advance_mode" id="is_advance_mode" value="yes" {!! $test->is_advance_mode=="yes" ? "checked" : '' !!}>
                    ...
                    <div class="form-group col-md-12">
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" name="is_support_negative" id="is_support_negative" value="Yes" {!! $test->is_support_negative=="yes" ? "checked" : '' !!}>
                                <label class="custom-control-label" for="is_support_negative">Support Negative Marking</label>
                            </div>
                        </div>
                    </div>
                    @if($test->is_support_negative=="yes")
                    <div class="form-group col-md-12">
                        <label for="negative_marks">Negative Marks <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Negative Marks" id="negative_marks" name="negative_marks" value="{{$test->negative_marks}}">
                    </div>
                    @else
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="access" id="free" value="Free" {!! $test->access=="Free" ? "checked" : '' !!}>
                                <label class="custom-control-label" for="free">Free</label>
                            </div>

                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="access" value="Paid" id="paid" {!! $test->access=="Paid" ? "checked" : '' !!}>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="test_type" id="live" value="Live" {!! $test->test_type=="Live" ? "checked" : '' !!}>
                                <label class="custom-control-label" for="live">Live</label>
                            </div>

                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="test_type" value="Coming Soon" id="coming" {!! $test->test_type=="Coming Soon" ? "checked" : '' !!}>
