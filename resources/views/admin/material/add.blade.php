...
@section('breadcrumb', 'Add Study Material')
@section('content')

<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Add Study Material <a href="{{ route('all-study-material') }}" class="btn btn-dark pull-right">Study Material List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Study Material</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Writer Name" id="writer_name" name="writer_name">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter PDF Title" id="pdf_title" name="pdf_title">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="access" id="free" value="Free">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group mb-3 mb-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="download_option" id="public" value="Public">
                                <label class="custom-control-label" for="public">Public</label>
                            </div>

                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" name="download_option" value="Private" id="private" checked>
