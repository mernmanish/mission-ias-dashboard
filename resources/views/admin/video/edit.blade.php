...
<div class="mb-3">
	<h4 class="mb-0 font-weight-semibold">
		Edit Video <a href="{{ route('all-videos') }}" class="btn btn-dark pull-right">Videos List</a>
	</h4>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header header-elements-inline bg-dark">
				<h5 class="card-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Edit Video Details</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Video Name" id="video_title" name="video_title" value="{{$video->video_title}}">
